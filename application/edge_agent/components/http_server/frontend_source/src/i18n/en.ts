export const en = {
  ...
  wifiScanFailed: 'Wi-Fi scan failed',
  wifiScanNoAps: 'No Wi-Fi networks found',
  wifiSelectSsid: 'Select from scan',
  wifiScanRefreshed: 'Scanned {count} networks',
  wifiSignal: '{rssi} dBm',
  wifiAuth: '{auth}',
  wifiScanRefresh: 'Refresh scan',
};
